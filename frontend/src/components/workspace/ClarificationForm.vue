...
<style scoped>
.clarification-form { container-type: inline-size; overflow: hidden; background: var(--paper); border: 0; border-radius: var(--radius-sm); box-shadow: var(--surface-shadow); }
...
.completion-track { height: 3px; background: var(--canvas-soft); }.completion-track i { display: block; height: 100%; background: linear-gradient(90deg, var(--coral-500), var(--rose-500)); transition: width .4s var(--ease-out); }
.question-workspace { display: grid; grid-template-columns: minmax(200px, .7fr) minmax(0, 1.5fr); }
.question-index { padding: 18px 14px; border-right: 1px solid var(--line); background: linear-gradient(160deg, var(--paper), var(--paper)); }
.question-index > button { width: 100%; padding: 12px; display: flex; align-items: center; gap: 10px; border: 1px solid transparent; border-radius: var(--radius-sm); background: none; text-align: left; transition: border-color .25s, background .25s, box-shadow .25s; }.question-index > button + button { margin-top: 6px; }.question-index > button:hover { background: white; }.question-index > button.active { background: white; border-color: var(--line); box-shadow: 0 4px 14px color-mix(in srgb, var(--shadow-color) 2%, transparent); }
.question-marker { flex: 0 0 auto; align-self: flex-start; width: 28px; height: 28px; display: grid; place-items: center; color: var(--ink-500); background: var(--canvas-soft); border-radius: var(--radius-sm); font-size: 10px; transition: background .25s; }.active .question-marker { background: var(--coral-600); color: white; }.answered .question-marker { background: var(--moss-700); color: white; }
...
.answer-surface { padding: 14px; display: grid; border: 0; border-radius: var(--radius-sm); background: var(--paper); box-shadow: inset 0 2px 5px color-mix(in srgb, var(--shadow-color) 2%, transparent); transition: box-shadow .25s, background .25s; }.answer-surface:focus-within { background: var(--paper); box-shadow: inset 0 0 0 1px var(--shadow-color), 0 0 0 3px color-mix(in srgb, var(--shadow-color) 8%, transparent); }.answer-surface textarea { width: 100%; min-height: 130px; max-height: 320px; padding: 0; resize: vertical; border: 0; outline: none; background: transparent; font-size: 15px; line-height: 1.9; }.answer-surface textarea::placeholder { color: var(--ink-500); }.answer-surface textarea:focus-visible { outline: none; }.answer-surface > span { padding-top: 8px; text-align: right; color: var(--ink-500); font-size: 10px; }
