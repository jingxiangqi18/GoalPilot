...
<template>
  <section class="planning-conversation" aria-label="目标规划对话">
    <div class="planning-messages" tabindex="0" role="region" aria-label="分析与澄清记录">
      <div class="planning-column">
        ...
        <article class="planning-response">
          <h2><span aria-hidden="true">✧</span> GoalPilot <small>目标分析</small></h2>
    ...
    <div class="planning-dock">
      ...
      <form v-if="current && !plan" class="clarification-composer" @submit.prevent="complete ? emit('clarify') : select(Math.min(activeIndex + 1, questions.length - 1))">
...
.planning-messages { flex: 1; min-height: 0; overflow-y: auto; padding: 28px; scrollbar-width: thin; scrollbar-color: #d8cce2 transparent; }
.planning-column { max-width: 800px; margin: auto; }.initial-intention { max-width: 88%; width: fit-content; margin: 0 0 30px auto; padding: 15px 21px; border-radius: 20px 5px 20px 20px; background: #ede7f3; }.initial-intention small { color: #7a6588; font-size: 10px; }.initial-intention p { margin: 5px 0 0; color: #675274; font-size: 14px; line-height: 1.8; white-space: pre-wrap; overflow-wrap: anywhere; }
.planning-response h2 { display: flex; align-items: center; gap: 10px; margin: 0 0 20px; color: #7c648d; font-family: var(--display); font-size: 13px; font-weight: 500; }.planning-response h2 > span { font-size: 26px; }.planning-response h2 small { font-size: 10px; color: #7a6585; }.known-points { margin: 18px 0; padding-left: 21px; color: #716179; font-size: 13px; line-height: 1.9; }.known-points li { margin-bottom: 7px; padding-left: 4px; }.known-points li::marker { color: #7c6489; }
.readiness-copy { color: #796683; font-size: 13px; line-height: 1.9; }.inline-action { display: flex; gap: 24px; margin-top: 18px; padding: 11px 16px; color: #725780; background: #e9e0f1; border: 0; border-radius: 11px; font-size: 13px; }.inline-action:hover:not(:disabled) { transform: translateY(-2px); }.inline-action:disabled { opacity: .5; }
.plan-artifact { display: flex; align-items: center; flex-wrap: wrap; gap: 15px; margin: 22px 0; padding: 20px; border-radius: 17px; background: linear-gradient(120deg, #ece6f6, #f5ebf1); }.artifact-icon { font-size: 30px; color: #7e638c; }.plan-artifact > div { min-width: 0; flex: 1; }.plan-artifact small { color: #7b6487; font-size: 11px; }.plan-artifact strong { display: block; margin-top: 5px; font-size: 15px; font-weight: 500; color: #675073; overflow-wrap: anywhere; }.plan-artifact p { margin: 7px 0 0; color: #7a6584; font-size: 11px; }.plan-artifact button { padding: 9px 12px; border: 0; border-radius: 8px; background: #fff8; color: #7d628e; font-size: 12px; }
.planning-pending { display: flex; align-items: center; gap: 10px; color: #7c6489; font-size: 13px; }.planning-pending i { width: 7px; height: 7px; border-radius: 50%; background: #b19ac3; animation: planning-pulse 1s ease-in-out infinite alternate; }
.answer-review { margin-top: 24px; }.answer-review h3 { color: #7c648a; font-size: 12px; font-weight: 500; }.answer-review h3 small { margin-left: 9px; color: #7a6584; font-size: 10px; }.answer-review button { display: block; width: 100%; margin-bottom: 10px; padding: 12px 16px; text-align: left; border: 0; border-radius: 12px; background: #f0eaf590; }.answer-review button > span { color: #7c6487; font-size: 11px; }.answer-review button > p { margin: 6px 0 0; color: #715d7d; font-size: 13px; white-space: pre-wrap; overflow-wrap: anywhere; }
.planning-dock { flex-shrink: 0; width: min(100%, 880px); margin: 0 auto; padding: 0 28px 17px; }.clarification-composer { padding: 15px 19px 12px; background: #fffdfef2; border: 1px solid #e0d6e8; border-radius: 20px; box-shadow: 0 8px 26px #72578908; }.clarification-composer:focus-within { border-color: #bda7cf; }.question-index { display: flex; align-items: center; flex-wrap: wrap; gap: 6px; margin-bottom: 13px; }.question-index button { width: 25px; height: 25px; padding: 0; border: 0; border-radius: 8px; color: #7a648a; background: #f1eaf6; font-size: 10px; }.question-index button.active { color: white; background: #9d80af; }.question-index > span { margin-left: auto; color: #7a6586; font-size: 10px; }
.clarification-composer label { display: block; color: #715b80; font-size: 13px; font-weight: 500; line-height: 1.7; }.clarification-composer textarea { display: block; width: 100%; min-height: 60px; max-height: 140px; margin: 10px 0; padding: 0; border: 0; background: transparent; resize: vertical; font-size: 14px; line-height: 1.8; }.clarification-composer textarea:focus { outline: none; }.clarification-composer textarea::placeholder { color: #796685; }.clarification-composer footer { display: flex; align-items: center; gap: 12px; }.clarification-composer footer small { margin-left: auto; color: #7a6586; font-size: 10px; }.clarification-composer footer button { padding: 7px 11px; min-height: 34px; border: 0; border-radius: 9px; color: #7c648c; background: #f4eef8; font-size: 11px; }.clarification-composer footer .next-question, .clarification-composer footer .submit-answers { color: white; background: #9276a4; }.clarification-composer button:disabled { opacity: .4; }
.planning-next { display: flex; justify-content: space-between; align-items: center; gap: 10px; flex-wrap: wrap; padding: 17px 20px; border: 1px solid #e3d8ec; border-radius: 16px; color: #7d638a; background: #fefbffb0; font-size: 12px; }.planning-next button { padding: 7px 11px; border: 0; border-radius: 8px; color: #7c638d; background: #eee5f5; font-size: 12px; }.planning-disclaimer { margin: 10px 0 0; text-align: center; font-size: 10px; color: #786684; line-height: 1.8; }
.planning-error { margin-bottom: 12px; padding: 12px 16px; border-radius: 12px; background: #faedf0; color: #995a6c; font-size: 12px; }.planning-error p { margin: 5px 0 0; line-height: 1.8; }
