...
.date-card, .session-card, .recent-card { overflow: hidden; background: rgba(255,255,255,.92); border: 0; border-radius: var(--radius-sm); box-shadow: var(--surface-shadow); }
.today-artwork { position: relative; padding: 19px; overflow: hidden; color: #fff; background: var(--accent-deep); }
...
.today-artwork header { display: flex; align-items: center; justify-content: space-between; color: var(--ink-500); font-size: 9px; font-weight: 600; letter-spacing: .13em; }
...
.date-lockup b { font-size: 19px; font-weight: 500; }.date-lockup small { margin-top: 6px; color: var(--ink-500); font-size: 11px; }
.today-artwork > p { margin: 19px 0 0; color: var(--ink-500); font-size: 12px; }
...
.week-strip strong { width: 29px; height: 29px; display: grid; place-items: center; border-radius: var(--radius-sm); font-size: 12px; font-weight: 500; }
.week-strip i { width: 3px; height: 3px; border-radius: 50%; }.week-strip .current { color: var(--coral-700); }.week-strip .current strong { color: white; background: linear-gradient(145deg, var(--coral-500), var(--coral-700)); box-shadow: 0 4px 9px color-mix(in srgb, var(--shadow-color) 14%, transparent); }.week-strip .current i { background: var(--rose-500); }
...
.recent-card li > button { width: 100%; padding: 13px 2px; display: grid; grid-template-columns: 34px minmax(0,1fr) 12px; align-items: center; gap: 10px; border: 0; border-radius: var(--radius-sm); background: transparent; text-align: left; transition: background .2s; }.recent-card li > button:hover { background: var(--canvas-soft); }
.goal-symbol { height: 34px; display: grid; place-items: center; background: var(--coral-100); border-radius: var(--radius-sm); color: var(--coral-700); font-size: 19px; }.symbol-1 { color: #9c697e; background: var(--rose-100); }.symbol-2 { color: var(--moss-700); background: var(--moss-100); }
